...
//        System.out.println(numHeroes);
        ...
        for (Hero hero : heroes.values()) {
            System.out.println((hero.getName()) + System.lineSeparator() + " HP: " + hero.getHitPoints() + System.lineSeparator() + " MP: " + hero.getManaPoints());
        }
...
//        int newHitPoints = hero.getHitPoints() + amount;
//        if (newHitPoints > 100) {
//            newHitPoints = 100;
//                }
